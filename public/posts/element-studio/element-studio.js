...
(function () {
  ...
  const FIELDS = {
    ...
    repeat:[S('count', 'How many', 1, 36, 1, 6), S('radius', 'Spread', 0, 0.6, 0.01, 0.34), { key: 'phase', label: 'Start angle°', kind: 'slider', min: 0, max: 360, step: 1, def: 0, deg: true }, S('twist', 'Swirl° (per copy)', -180, 180, 1, 0)],
    nest:  [S('count', 'How many', 1, 12, 1, 3), S('twist', 'Spiral° (per ring)', -180, 180, 1, 0)],
